...
public class AlignRight3Command extends Command {
    ...
    public AlignRight3Command(SwerveDriveSubsystem swerveDriveSubsystem, LimelightSubsystem limelightSubsystem, IntakeSubsystem m_IntakeSubsystem, GenericHID m_controller) {
