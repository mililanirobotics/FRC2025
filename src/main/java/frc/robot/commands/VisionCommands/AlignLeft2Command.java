...
public class AlignLeft2Command extends Command {
    ...
    public AlignLeft2Command(SwerveDriveSubsystem swerveDriveSubsystem, LimelightSubsystem limelightSubsystem, IntakeSubsystem m_IntakeSubsystem, GenericHID m_controller) {
