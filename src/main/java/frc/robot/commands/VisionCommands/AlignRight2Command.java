...
public class AlignRight2Command extends Command {
    ...
    public AlignRight2Command(SwerveDriveSubsystem swerveDriveSubsystem, LimelightSubsystem limelightSubsystem, IntakeSubsystem m_IntakeSubsystem, GenericHID m_controller) {
        ...
        yAxisPID = new PIDController(0.2, LimelightConstants.kAlignCenterI, LimelightConstants.kAlignCenterD);
    ...
    public void initialize() {
        ...
        //     yoffset = Math.toRadians(LimelightConstants.kRightSlotLAlignOffset);
        // }
        if (m_IntakeSubsystem.isCoralInRightSlot()) {
            yoffset = Math.toRadians(LimelightConstants.kRightSlotRAlignOffset);
        }        
        else {
            validConditions = false;
        }
        xoffset = Math.toRadians(LimelightConstants.kVertical2AlignOffset);
