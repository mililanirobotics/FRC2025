...
public class ElevatorStorageCommand extends Command {
    
    private ElevatorSubsystem m_elevatorSubsystem;

    public ElevatorStorageCommand(ElevatorSubsystem elevatorSubsystem){
    ...
    public void initialize(){
        m_elevatorSubsystem.setPoint(ElevatorConstants.kStorageCounts);
    }
