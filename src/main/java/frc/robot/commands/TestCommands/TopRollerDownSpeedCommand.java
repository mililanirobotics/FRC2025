...
public class TopRollerDownSpeedCommand extends Command{
    ...
    public void initialize () {
        //Please note that this motor is reversed. I will change it back later and simply configure it to be reversed...
        m_IntakeSubsystem.setRollerTopPower(m_IntakeSubsystem.getTopSpeed() + 0.1);
    }
